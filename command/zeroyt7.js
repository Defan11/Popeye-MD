/* BASE ORI CREATED By ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×
Follow Me On All Sosial Media
• My Youtube : ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×
...
var isOwner = global.owner == m.sender ? true : ["6281321776496@s.whatsapp.net"].includes(m.sender) ? true : false
...
thumbnail: (fake), 
surface: 200, 
message: `Creted By ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×`, 
orderTitle: 'Created By ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×', 
...
zeroyt7.sendImage(from, media.thumb, txt, ftroli)
zeroyt7.sendMessage(from, { audio: { url: media.dl_link }, mimetype: 'audio/mpeg', fileName: `${media.title}.mp3` }, { quoted: ftroli })
}
break
case 'ytmp4': {
...
zeroyt7.sendMessage(from, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: txt }, { quoted: ftroli })
}
break
case 'mediafire': {
...
*Link* : ${baby1[0].link}`
reply(`${txt}`)
zeroyt7.sendMessage(from, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : ftroli }).catch ((err) => reply(mess.success))
}
break
case 'gitclone': {
...
zeroyt7.sendMessage(from, { video: { url: data.nowm }}, { quoted: ftroli })
})
}
break
case 'tiktokaudio': {
...
zeroyt7.sendMessage(from, zero, { quoted : ftroli })
})
}
break
case 'play': {
...
*Sisi Positif :* ${anu.message.sisi_positif}
*Sisi Negatif :* ${anu.message.sisi_negatif}`
zeroyt7.sendImage(from,  anu.message.gambar, txt, ftroli)
}
break
case 'sifatusaha': {
...
*Arti :* ${anu.message.arti}
*Catatan :* ${anu.message.catatan}`
zeroyt7.sendImage(from, anu.message.image, txt, ftroli)
}
break
case 'harisangar': {
if (!text) return reply(`Masukan Tgl Lahir Kamu\nContoh : ${prefix + command} 6, 3, 2003`)
...
zeroyt7.sendMessage(from,{text:te,mentions: [y], },{quoted:ftroli})
} catch (err) {
...
zeroyt7.sendMessage(from, {audio:inicdd, mimetype:'audio/mpeg', ptt:true}, {quoted:ftroli})
}
break
...
zeroyt7.sendMessage(from, {image:{url:x.url}, caption: creator, mentions:[sender]},{quoted:ftroli})})
break
case 'kisahnabi': {
