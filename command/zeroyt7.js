...
• https://sociabuzz.com/ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×/tribe
*/
...
var thumbnail = fs.readFileSync('./file/image/ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.jpg')
...
module.exports = ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜× = async (ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×, m, chatUpdate, store) => {
try {
...
var botNumber = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.decodeJid(ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.user.id)
...
var groupMetadata = m.isGroup ? await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupMetadata(from).catch(e => {}) : ''
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.readMessages([m.key])

//━━━━━━━━━━━━━━━[ CONSOLE ]━━━━━━━━━━━━━━━━━//

ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendPresenceUpdate('available', from)
...
orderTitle: 'Created ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×', 
...
kice = m.sender
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, {text:`*GROUP LINK DETECTOR*\n\n@${kice.split("@")[0]} Akan Dikick Karena Mengirim Link Di Group Ini`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
setTimeout( () => {
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupParticipantsUpdate(from, [kice], 'remove').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}, 3000)
} else {
}
}
...
userJid: ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.user.id,
quoted : m.quoted && m.quoted.fakeObj
})
messages.key.fromMe = areJidsSameUser(m.sender, ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.user.id)
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.ev.emit('messages.upsert', msg)
}
...
• Ortuku
• All Creator Bot'
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { viewOnce : true, caption: menu, image: thumbnail, templateButtons: buttonsDefault, footer: creator, mentions: [m.sender] })
}
break
case 'allmenu' : {
...
• ${prefix}bacaansholat
`
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { viewOnce : true, caption: allmenu, image: thumbnail, templateButtons: buttons2, footer: creator, mentions: [m.sender] })
}
break
...
let response = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupInviteCode(from)
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendText(from, `https://chat.whatsapp.com/${response}\n\n• Link Group : ${groupMetadata.subject}`, ftroli, { detectLink: true })
}
break
case 'ephemeral': {
if (!m.isGroup) return reply(mess.group)
...
if (args[0] === 'enable') {
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { disappearingMessagesInChat: WA_DEFAULT_EPHEMERAL }).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'disable') {
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { disappearingMessagesInChat: false }).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
} else {
let buttons = [
...
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendButtonText(from, buttons, `Silahkan Pilih Mode Group`, creator, ftroli)
}
}
break
case 'setppgroup': {
...
let media = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.downloadAndSaveMediaMessage(quoted)
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.updateProfilePicture(from, { url: media }).catch((err) => fs.unlinkSync(media))
reply(mess.success)
}
break
case 'setname': {
...
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupUpdateSubject(from, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'setdesc': {
if (!m.isGroup) return reply(mess.group)
...
if (!isAdmins) return reply(mess.admin)
if (!text) return reply( 'Textnya Mana Kak ?')
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupUpdateDescription(from, text).then((res) => ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'group': {
if (!m.isGroup) return reply(mess.group)
...
if (!isAdmins) return reply(mess.admin)
if (args[0] === 'close'){
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupSettingUpdate(from, 'announcement').then((res) => reply(`Sukses Menutup Group`)).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'open'){
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupSettingUpdate(from, 'not_announcement').then((res) => reply(`Sukses Membuka Group`)).catch((err) => reply(jsonformat(err)))
} else {
let buttons = [
...
if (!isAdmins) return reply(mess.admin)
if (args[0] === 'open'){
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupSettingUpdate(from, 'unlocked').then((res) => reply(`Sukses Membuka Edit Info Group`)).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'close'){
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupSettingUpdate(from, 'locked').then((res) => reply(`Sukses Menutup Edit Info Group`)).catch((err) => reply(jsonformat(err)))
} else {
let buttons = [
{ buttonId: 'editinfo open', buttonText: { displayText: 'Buka' }, type: 1 },
{ buttonId: 'editinfo close', buttonText: { displayText: 'Tutup' }, type: 1 }
]
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendButtonText(from, buttons, `Silahkan Pilih Mode Edit Info`, creator, ftroli)
}
}
break
case 'add': {
...
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupParticipantsUpdate(from, [add], 'add').then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'kick': {
if (!m.isGroup) return reply(mess.group)
...
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupParticipantsUpdate(from, [kick], 'remove').then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'hidetag': {
if (!m.isGroup) return reply(mess.group)
if (!isAdmins) return reply(mess.admin)
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: ftroli })
}
break
case 'tagall': {
if (!m.isGroup) return reply(mess.group)
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { text: teks, mentions: participants.map(a => a.id) }, { quoted: ftroli })
}
break
case 'promote': {
if (!m.isGroup) return reply(mess.group)
...
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupParticipantsUpdate(from, [promote], 'promote').then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'demote': {
if (!m.isGroup) return reply(mess.group)
...
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupParticipantsUpdate(from, [demote], 'demote').then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'antilink': {
if (!m.isGroup) return reply(mess.group)
...
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendButtonText(from, buttons, `Silahkan Pilih Mode Antilink`, creator, ftroli)
}
}
break
case 'listonline': {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendText(from, 'List Online :\n\n' + online.map(v => '• @' + v.replace(/@.+/, '')).join`\n`, ftroli, { mentions: online })
}
break
case 'toimage': {
...
reply(mess.wait)
let toimage = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.downloadAndSaveMediaMessage(quoted)
let ran = await getRandom('.png')
exec(`ffmpeg -i ${toimage} ${ran}`, (err) => {
fs.unlinkSync(toimage)
if (err) return reply(err)
let buffer = fs.readFileSync(ran)
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { image: buffer }, { quoted: ftroli })
fs.unlinkSync(ran)
})
}
break
...
localFile = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.downloadAndSaveMediaMessage(quoted, hmm)
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, {image: fs.readFileSync(outputFile), caption: mess.success}, { quoted : ftroli })
...
let encmedia = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendImageAsSticker(from, sticker, ftroli, { packname: packname, author: author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) reply('Maksimal 10 detik!')
let stiker = await quoted.download()
let encmedia = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendVideoAsSticker(from, stike, ftroli, { packname: packname, author: author })
await fs.unlinkSync(encmedia)
} else {
...
let video = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(video)
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video'} }, { quoted: ftroli })
...
reply(mess.wait)
let { webp2mp4File } = require('../message/uploader')
let gif = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(gif)
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, { quoted: ftroli })
...
let url = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.downloadAndSaveMediaMessage(quoted)
if (/image/.test(mime)) {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By Zero YT7.mp3`}, { quoted : ftroli })
}
break
case 'tovn': {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:ftroli})
}
break
case 'join': {
...
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupAcceptInvite(join).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'leave': {
if (!isOwner) return reply(mess.owner)
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupLeave(from).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'block': {
if (!isOwner) return reply(mess.owner)
let block = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.updateBlockStatus(block, 'block').then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'unblock': {
if (!isOwner) return reply(mess.owner)
let unblock = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.updateBlockStatus(unblock, 'unblock').then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'setppbot': {
if (!isOwner) return reply(mess.owner)
...
if (/webp/.test(mime)) return reply(`Kirim/Reply Image Dengan Caption ${prefix + command}`)
let media = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.downloadAndSaveMediaMessage(quoted)
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.updateProfilePicture(botNumber, { url: media }).catch((err) => fs.unlinkSync(media))
reply(mess.success)
}
break
case 'setbio': {
if (!isOwner) return reply(mess.owner)
if (!text) return reply(`Textnya Mana Kak ?`)
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.setStatus(q)
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendTextWithMentions(from, teks, ftroli)
}
break
case 'listgc': {
if (!isOwner) return reply(mess.owner)
...
for (let i of anu) {
let metadata = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.groupMetadata(i)
...
Instagram : https://instagram.com/defan_sugiarto
...
• All Creator Bot
• All Subscriber Ku`
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { viewOnce : true, caption: tekssc, image: thumbnail, templateButtons: buttons3, footer: creator, mentions: [m.sender] })
}
break
case 'owner': {
...
+ `END:VCARD`
let msg = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { contacts: { displayName: `${global.owner}`, contacts: [{ vcard }] } }, { quoted: ftroli })
let buttons3 = [
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, buttonMessage3, { quoted: ftroli })                        
}
break
case 'ytmp3': {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendImage(from, media.thumb, txt, ftroli)
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { audio: { url: media.dl_link }, mimetype: 'audio/mpeg', fileName: `${media.title}.mp3` }, { quoted: ftroli })
}
break
case 'ytmp4': {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: txt }, { quoted: ftroli })
}
break
case 'mediafire': {
...
*Link* : ${baby1[0].link}`
reply(`${txt}`)
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : ftroli }).catch ((err) => reply(mess.success))
}
break
case 'gitclone': {
if (!args[0]) return reply(`Masukan Link Github Nya\nContoh : ${prefix}${command} https://github.com/Zero-YT7/Popeye-MD`)
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: ftroli }).catch((err) => reply(mess.success))
}
break
case 'tiktoknowm': {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { video: { url: data.nowm }}, { quoted: ftroli })
})
}
break
case 'tiktokaudio': {
...
reply(mess.wait)
require('../message/scrape/tiktok').Tiktok(q).then( data => {
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { audio: { url: data.audio }, mimetype: 'audio/mp4' }, { quoted: ftroli })
})
}
break
case 'searchgc': {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, zero, { quoted : ftroli })
})
}
break
case 'play': {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, buttonMessage, { quoted: ftroli })
}
break
case 'ytsearch': {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { image: { url: search.all[0].thumbnail },  caption: teks }, { quoted: ftroli })
}
break
case 'google': {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { audio: { url: result.audio }, fileName: result.title+'.mp3', mimetype: 'audio/mpeg' }, { quoted: ftroli })
}
break
case 'fakemore': {
...
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendButtonText(from, buttons, jawab, creator, ftroli, {mentions: menst})
}
break
case 'jodohku': {
if (!m.isGroup) return reply(mess.group)
...
await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendButtonText(from, buttons, jawab, creator, ftroli, {mentions: ments})
}
break
case 'nomerhoki': {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendText(from, txt, ftroli)
}
breakbreak
case 'artimimpi': {
...
*Sisi Positif :* ${anu.message.sisi_positif}
*Sisi Negatif :* ${anu.message.sisi_negatif}`
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendImage(from,  anu.message.gambar, txt, ftroli)
}
break
case 'sifatusaha': {
...
*Arti :* ${anu.message.arti}
*Catatan :* ${anu.message.catatan}`
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendImage(from, anu.message.image, txt, ftroli)
}
break
case 'harisangar': {
if (!text) return reply(`Masukan Tgl Lahir Kamu\nContoh : ${prefix + command} 6, 3, 2003`)
...
*Lahir :* ${anu.message.tgl_lahir}
*Hasil :* ${anu.message.result}`
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendText(from, txt, m)
}
break
case 'memancing': {
...
.then((data) => ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { image: { url: data }, caption: creator }, { quoted: ftroli }))
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, { image: { url: anu }, caption: creator }, { quoted: ftroli })
}
break
case 'jadibot': {
if (!isOwner) return reply(mess.owner)
jadibot(ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×, ftroli, from)
}
break
case 'listjadibot':
if (!isOwner) return reply(mess.owner)
try {
let user = [... new Set([...global.conns.filter(ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜× => ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.user).map(ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜× => ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.user)])]
te = "*List Jadibot*\n\n"
for (let i of user){
let y = await ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.decodeJid(i.id)
te += " × User : @" + y.split("@")[0] + "\n"
te += " × Name : " + i.name + "\n\n"
}
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from,{text:te,mentions: [y], },{quoted:ftroli})
} catch (err) {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, {audio:inicdd, mimetype:'audio/mpeg', ptt:true}, {quoted:ftroli})
}
break
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(from, {image:{url:x.url}, caption: creator, mentions:[sender]},{quoted:ftroli})})
break
case 'kisahnabi': {
...
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.copyNForward(from, msgs[budy.toLowerCase()], true)
}
}

} catch (err) {
ᴹᴿ᭄defα͢͢͢ή፝֟͜* ×፝֟͜×.sendMessage(m.key.remoteJid, { text: `*[ERROR !!!]*\n${err}` }, { quoted: m })
}
}
